/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config wrangler.zeroth.jsonc src/worker-configuration.d.ts` (hash: c83908d708a32bca3bd0ed7aae7a66e4)
// Runtime types generated with workerd@1.20260603.1 2026-06-04
interface __BaseEnv_Env {
	ZEROTH_DB: D1Database;
	EMAIL: SendEmail;
	PUBLIC_BASE_URL: "https://id.wavey.ai";
	PRODUCT_NAME: "Wavey ID";
	SESSION_COOKIE_NAME: "wavey_id_session";
	...
	MAGIC_LINK_DELIVERY: "cloudflare_email";
	APPLE_NATIVE_CLIENT_IDS: "ai.wavey.id";
...
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("../../zeroth/crates/zeroth-worker/build/worker/shim");
	}
