...
put_optional_secret APPLE_APP_SITE_ASSOCIATION_JSON
put_optional_secret RESEND_API_KEY
put_optional_secret MAGIC_LINK_RESEND_API_KEY
put_optional_secret MAILCHANNELS_API_KEY
put_optional_secret MAGIC_LINK_MAILCHANNELS_API_KEY
